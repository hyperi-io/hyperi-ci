...
``scalo.deployment.topology`` (shared cross-language data type).
...
Consumers should import data types from scalo and operational helpers
from here:

.. code-block:: python

    from scalo.deployment.topology import DeploymentTopology, load_topology
